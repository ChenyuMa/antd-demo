<template>
  <div class="ml-text">
    <div class="ml_1">
      <img src="../../public/5_title.png">
    </div>
    <div class="ml_2">
    <br/>
      <div class='ml_2_1'>
        <div style="font-family:HelveticaNeueMedium;">
          #WRITE IN UNPREDICTABLE WAYS# Write in unpredictable ways ingredient: Neural network LSTM + RNN model Weibo analyze our online behavior, give recommendation and force us to follow some accounts. Now, add some randomness in your weibo writing, fight Weibo with the unpredictable.
        </div>
        <div >使用变幻莫测的话术来发博文
果酱结构：神经网络LSTM + RNN模型
微博根据我们的浏览记录，关注人群，甚至个人博文分析用户行为，给我们推荐内容，甚至强制让我们关注一些账号。现在，使用LSTM+RNN神经网络果酱，为你的博文增加随机性，用变幻莫测的话术来反击微博。
</div>
</div>
    </div>
    <div class="ml_3">
